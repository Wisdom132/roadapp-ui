          ...
          <div id="login-page" class="row">
            <div class="col s12 z-depth-6 card-panel ">
              <form class="login-form" @submit.prevent="registerNewUser">
                ...
                <div class="row">
                  <div class="input-field col l6">
                    ...
                    <input
                      ...
                      type="text"
                    />
                    <label for="address" data-error="wrong" data-success="right"
                      >Address</label
                    >
                  </div>
                  ...
                  <div class="input-field col l3">
                    ...
                    <label for="gender" data-error="wrong" data-success="right"
                      >Gender</label
                    >
                  </div>
                </div>
                <div class="row">
                  <div class="input-field col l6">
                    ...
                    <input
                      ...
                      type="text"
                    />
                    <label for="state" data-error="wrong" data-success="right"
                      >State</label
                    >
                  </div>
                  <div class="input-field col l6">
                ...
                <div class="row">
                  <div class="input-field col l4">
                    ...
                    <input
                      ...
                      type="text"
                    />
                    <label for="vehicleMake" data-error="wrong" data-success="right"
                      >vehicle Make</label
                    >
                  </div>
                  <div class="input-field col l4">
                 ...
                 <div class="row">
                  <div class="input-field col l4">
                    ...
                    <input
                      ...
                      type="text"
                    />
                    <label for="vehicle_class" data-error="wrong" data-success="right"
                      >Vehicle Class</label
                    >
                  </div>
                  <div class="input-field col l4">
                ...
                <div class="row">
                  <div class="input-field col l4">
                    ...
                    <input
                      ...
                      type="number"
                    />
                    <label for="chassic_number" data-error="wrong" data-success="right"
                ...
                <div class="row">
                  <div class="col s12">
                    <button class="btn blue darken-3" type="submit">
                      Submit
                    </button>
                  </div>
                </div>
  ...
  methods: {
    async registerNewUser() {
      try {
        ...
        this.register = {}
        swal('Success', `Hello "${response.data.data.vehicle_owner_details.name}" Your Plate number is "${response.data.data.plate_number}"`, 'success')
      } catch (err) {
